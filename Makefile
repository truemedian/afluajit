...
INSTALL_DEFINC= $(DPREFIX)/include/afluajit-$(MMVERSION)
INSTALL_INC=   $(INSTALL_DEFINC)

export INSTALL_LJLIBD= $(INSTALL_SHARE_)/afluajit-$(MMVERSION)
...
INSTALL_TNAME= afluajit-$(VERSION)
INSTALL_TSYMNAME= afluajit
INSTALL_ANAME= libafluajit-$(ABIVER).a
INSTALL_SOSHORT1= libafluajit-$(ABIVER).so
INSTALL_SOSHORT2= libafluajit-$(ABIVER).so.$(MAJVER)
INSTALL_SONAME= libafluajit-$(ABIVER).so.$(VERSION)
INSTALL_DYLIBSHORT1= libafluajit-$(ABIVER).dylib
INSTALL_DYLIBSHORT2= libafluajit-$(ABIVER).$(MAJVER).dylib
INSTALL_DYLIBNAME= libafluajit-$(ABIVER).$(VERSION).dylib
INSTALL_PCNAME= afluajit.pc
